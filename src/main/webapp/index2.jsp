        ...
        <form class="form-horizontal">
		  ...
		  <div class="form-group">
		   ...
		   <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" name="empaddr" class="form-control" id="addr_add_input" placeholder="address">
		      <span class="help-block"></span>
		    </div>
		  </div>
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		    	<!-- 部门提交部门id即可 -->
		      <select class="form-control" name="empdepid">
		      </select>
		    </div>
		  </div>
		</form>
...
<div class="modal fade" id="empAddModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
      ...
      <div class="modal-body">
        <form class="form-horizontal">
		  ...
		  <div class="form-group">
		    ...
		    <label class="col-sm-2 control-label">addr</label>
		    <div class="col-sm-10">
		      <input type="text" name="addr" class="form-control" id="addr_add_input" placeholder="address">
		      <span class="help-block"></span>
		    </div>
		  </div>
	<!-- 	  <div class="form-group">
	...
	<div class="container">
        ...
        <div class="col-md-1 col-md-offset-1">
                   <input type="submit" value="查询" class="btn btn-primary" onclick="find();"/>
            </div>       
	...
	<script type="text/javascript">
		...
		function to_page(pn,empname,empemail){
			$.ajax({
				url:"${APP_PATH}/allemps",
		...
		/* 		var genderTd = $("<td></td>").append(item.gender=='M'?"男":"女"); */
				...
				var empaddr = $("<td></td>").append(item.empaddr);
		...
		function getDepart(ele){
			$(ele).text("");
			$.ajax({
				url:"${APP_PATH}/alldepart",
				data:"", 
				type:"GET",
				success:function(result){
				$.each(result.extend.alldepart,function(){
		...
		function getEmp(id){
			$.ajax({
				...
				success:function(result){
					...
					$("#addr_add_input").val(empData.empaddr);
					$("#empUpdateModal select").val([empData.empdepid]);
				}
			});
		}
		//点击更新，更新员工信息
